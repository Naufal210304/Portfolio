...
const HeroSection = () => {
  ...
  return (
    <section
      id="home"
      className="relative h-screen w-full flex flex-col justify-center px-8 md:px-16 lg:px-24 py-8 bg-black"
    >
      {/* Header */}
      <div className="absolute top-7 left-8 right-8 md:left-16 md:right-16 lg:left-24 lg:right-24 flex justify-between items-center z-10">
        ...
        <div className="flex items-center gap-6">
          ...
          <button
            ...
            className="text-white/70 hover:text-[#38bdf8] transition-all duration-300 cursor-pointer drop-shadow-[0_0_8px_rgba(56,189,248,0)] hover:drop-shadow-[0_0_8px_rgba(56,189,248,0.5)]"
          >
        ...
        <a
          href="/resume.pdf"
          download="Muhammad_Naufal_Resume.pdf"
      ...
      <div className="flex flex-col items-start gap-3 mt-4 md:pl-12 lg:pl-24">
        ...
        <div className="h-10 md:h-12 flex items-center">
          <p className="text-xl md:text-3xl font-mono text-white tracking-tight">
            ...
            <span className="text-[#38bdf8] drop-shadow-[0_0_10px_rgba(56,189,248,0.7)]">
              {text}
            </span>

            <span className="animate-pulse border-l-2 border-[#38bdf8] ml-1"></span>
          </p>
        </div>
